(function(exports){
	...
	exports.identifyHash = function(phash){
		...
		var hash_arr = [
			...
			{regex: /^[a-f0-9]{40}$/i, hashes: ["SHA-1","Double SHA-1","MaNGOS CMS","MaNGOS CMS v2","LinkedIn","RIPEMD-160","Haval-160","Tiger-160","HAS-160","Skein-256(160)","Skein-512(160)"]},
			...
			{regex: /^(\$2[axy]|\$2)\$[0-9]{0,2}?\$[a-z0-9\/\.]{53}$/i, hashes: ["Blowfish(OpenBSD)","bcrypt"]},
			{regex: /^[a-f0-9]{40}:[a-f0-9]{16}$/i, hashes: ["Samsung Android Password/PIN"]},
			{regex: /^S:[a-f0-9]{60}$/i, hashes: ["Oracle 11g"]},
			{regex: /^\$bcrypt-sha256\$.{5}\$[a-z0-9\/\.]{22}\$[a-z0-9\/\.]{31}$/i, hashes: ["BCrypt(SHA-256)"]},
