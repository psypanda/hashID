(function(exports){
	...
	exports.identifyHash = function(phash){
		...
		var hash_arr = [
			...
			{regex: /^[a-f0-9]{16}$/i, hashes: ["MySQL323","DES(Oracle)","VNC","Half MD5","Oracle 7-10g","FNV-164","CRC-64"]},
			...
			{regex: /^[a-f0-9]{32}$/i, hashes: ["MD5","MD4","MD2","NTLM","LM","RAdmin v2.x","RIPEMD-128","Haval-128","Tiger-128","Snefru-128","MD5(ZipMonster)","DCC","DCC v2","Skein-256(128)","Skein-512(128)"]},
			...
			{regex: /^\$H\$[a-z0-9\/\.]{31}$/i, hashes: ["MD5(phpBB3)","PHPass' Portable Hash"]},
			{regex: /^\$P\$[a-z0-9\/\.]{31}$/i, hashes: ["MD5(Wordpress)","PHPass' Portable Hash"]},
			...
			{regex: /^[a-f0-9]{32}:.{5}$/i, hashes: ["IP.Board v2+","MyBB v1.2+"]},
			{regex: /^[a-z0-9]{34}$/i, hashes: ["CryptoCurrency(Adress)"]},
			{regex: /^[a-f0-9]{40}$/i, hashes: ["SHA-1","SHA-1(MaNGOS)","SHA-1(MaNGOS2)","SHA-1(LinkedIn)","RIPEMD-160","Haval-160","Tiger-160","HAS-160","Skein-256(160)","Skein-512(160)"]},
			...
			{regex: /^[a-f0-9]{56}$/i, hashes: ["SHA-224","Haval-224","Keccak-224","Skein-256(224)","Skein-512(224)"]},
			...
			{regex: /^[a-f0-9]{64}$/i, hashes: ["SHA-256","RIPEMD-256","Haval-256","Snefru-256","GOST R 34.11-94","Keccak-256","Skein-256","Skein-512(256)","Ventrilo"]},
			...
			{regex: /^[a-f0-9]{96}$/i, hashes: ["SHA-384","Keccak-384","Skein-512(384)","Skein-1024(384)"]},
			{regex: /^{SSHA512}[a-z0-9\+\/]{96}={0,2}$/i, hashes: ["SSHA-512(Base64)","LDAP(SSHA512)"]},
			{regex: /^{ssha512}[a-z0-9\.\$]{107}$/i, hashes: ["AIX(ssha512)"]},
			{regex: /^[a-f0-9]{128}$/i, hashes: ["SHA-512","Whirlpool","Salsa10","Salsa20","Keccak-512","Skein-512","Skein-1024(512)"]},
			...
			{regex: /^sha1\$[a-z0-9\/\.]{1,12}\$[a-f0-9]{40}$/i, hashes: ["SHA-1(Django)"]},
			...
			{regex: /^sha256\$[a-z0-9\/\.]{1,12}\$[a-f0-9]{64}$/i, hashes: ["SHA-256(Django)"]},
			{regex: /^sha384\$[a-z0-9\/\.]{1,12}\$[a-f0-9]{96}$/i, hashes: ["SHA-384(Django)"]},
