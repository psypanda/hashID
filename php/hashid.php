...
function IdentifyHash($str)
{
  ...
  (
    ...
    '/^\$1\$[a-z0-9\/\.]{0,8}\$[a-z0-9\/\.]{22}$/i' => 'MD5(Unix),Cisco-IOS(MD5),FreeBSD MD5',
    ...
    '/^[a-f0-9]{40}$/i' => 'SHA-1,RIPEMD-160,Haval-160,SHA-1(MaNGOS),SHA-1(MaNGOS2),Tiger-160,HAS-160,Skein-256(160),Skein-512(160)',
    '/^\*[a-f0-9]{40}$/i' => 'MySQL5.x,MySQL4.1',
    '/^[a-z0-9]{43}$/i' => 'Cisco-IOS(SHA256)',
    '/^[a-f-0-9]{32}:[^\\\/:*?\"\<\>\|]{1,15}$/i' => 'Domain Cached Credentials 2',
