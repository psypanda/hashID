...
prototypes = [
    ...
    Prototype(
        ...
        modes=[
            HashInfo(name='MD2', hashcat=None, john=None, extended=False)]),
    Prototype(
    ...
    Prototype(
        ...
        modes=[
            HashInfo(name=u'Wordpress ≥ v2.6.2', hashcat=400, john=None, extended=False),
            HashInfo(name=u'Joomla ≥ v2.5.18', hashcat=400, john=None, extended=False),
            HashInfo(name="PHPass' Portable Hash", hashcat=400, john=None, extended=False)]),
    Prototype(
    ...
    Prototype(
        ...
        modes=[
            HashInfo(name=u'Android FDE ≤ 4.3', hashcat=8800, john=None, extended=False)]),
    Prototype(
